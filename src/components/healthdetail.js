  ...
  return (
    ...
    <div className="flex flex-col mt-5 w-max-prose">
      {form.allergies.length > 0 ? (
        <div>
          <label htmlFor="Allergies" className="input-label text-base mb-2">
            Allergies
          </label>
      ...
      {form.medications.length > 0 ? (
        <div className="mt-5">
          <label htmlFor="Medications" className="input-label text-base mb-2">
            Medications
          </label>
          <div className="flex flex-wrap overflow-hidden">
      ...
      {form.allergies.length > 0 || form.medications.length > 0 ? (
        <div className="m-3">
          <button onClick={handleSubmit} className="bg-white text-gray-800 font-bold rounded border-b-2 border-green-500 hover:border-green-600 hover:bg-green-500 hover:text-white shadow-md py-2 px-6 inline-flex items-center">
