...
export default function PublicNavBar() {
    ...
    return (
        <nav className="flex items-center justify-between flex-wrap bg-grey">
            <A href="/">
                <div className="flex-shrink-0 pt-5 h-16 border-b-2 border-gray-200 flex items-center px-4">
                    <img className="h-20 w-20" src={img} alt="DermaCam logo" />
                </div>
            </A>
            ...
            <div
                className={`w-full ${
                    shown ? "block" : "hidden"
                } flex-grow lg:flex lg:items-center lg:w-auto lg:justify-center lg:bg-grey bg-grey pb-6 lg:p-6`}>
