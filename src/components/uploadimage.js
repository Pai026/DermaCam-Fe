    ...
    <table className="text-left w-max-prose border-collapse">
      ...
      {result.Suggested_Products.map((item)=>{
        return (
          ...
          <td className="py-4 px-6 border-b border-grey-light">{item.product_name}</td>
          <td className="py-4 px-6 border-b border-grey-light">
            <a href={item.brand_link} target="_blank" rel="noreferrer"><button className="h-6 md:h-12 w-full inline-block md:text-sm text-xs bg-blue-300 hover:bg-blue text-blue-dark font-semibold hover:text-black py-2 px-4 border border-blue hover:border-transparent rounded-full">View</button></a>
          </td>
          </tr>
        )
      })}
          ...
          {showButton?<footer className="flex justify-center p-2">
            <button
          ...
          </footer>:<footer className="flex justify-center p-2">
            <button
